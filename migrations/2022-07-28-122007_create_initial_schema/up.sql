...
ALTER TABLE objects ADD FOREIGN KEY (origin_id, origin_revision) REFERENCES objects(id, revision_number); -- objects table cannot reference itself until created
